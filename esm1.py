...
plt.xlabel("time\n(s)")
plt.ylabel("u\n(m/s)")
plt.plot(arr4funcAtDT[2], '.b', label="Euler")
plt.plot(arr4funcAtDT[1], "r", label="Analytical")
plt.legend()
...
plt.xlabel("time\n(s)")
plt.ylabel("Energy")
plt.plot(timeArr, engAnaArr, "k", label="Analytic")
plt.plot(timeArr, leapFrogEngArr, ".r", label="Leapfrog")
plt.plot(timeArr, heunEngArr, "xb", label="Heun")
plt.legend()
...
plt.xlabel("time\n(m/s)")
plt.ylabel("Energy")
plt.semilogy(timeArr, engAnaArr, "k", label="Analytic")
plt.semilogy(timeArr, eulerEngArr,".g", label="Euler")
plt.legend()
...
plt.ylabel("Energy")
plt.plot(timeArr, engAnaArr, "k", label="Analytic")
plt.plot(timeArr, matsunoEngArr,".b", label="Matsuno")
plt.legend()
...
plt.plot(heunErrVdt, "xg", label="heun")
plt.legend()
